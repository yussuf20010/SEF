...
// Exclude language files from being processed
gulp.task('lang', function() {
    return gulp.src(['./src/assets/lang/**/*.json', '!./src/assets/lang/en.json', '!./src/assets/lang/ar.json'])
        .pipe(gulp.dest('./www/assets/lang'));
});
