...
export class CoreSettingsHelperProvider {
    ...
    protected currentColorScheme = CoreColorScheme.DARK;
        ...
        if (!CoreConstants.CONFIG.forceColorScheme) {
            ...
            const applySiteScheme = (): void => {
                if (this.isColorSchemeDisabledInSite()) {
                    ...
                    this.setColorScheme(CoreColorScheme.DARK);
                } else {
    ...
    async initColorScheme(): Promise<void> {
        if (CoreConstants.CONFIG.forceColorScheme) {
            ...
            const scheme = await CoreConfig.get(CoreConstants.SETTINGS_COLOR_SCHEME, CoreColorScheme.DARK);
    ...
    setColorScheme(colorScheme: CoreColorScheme): void {
        ...
        if (colorScheme == CoreColorScheme.DARK && this.prefersDark) {
